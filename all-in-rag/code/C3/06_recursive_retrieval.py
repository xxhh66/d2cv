...
Settings.embed_model = HuggingFaceEmbedding(
    ...
    device="cpu" # cpu, cuda, ipu, xpu, mkldnn, opengl, opencl, ideep, hip, ve, fpga, maia, xla, lazy, vulkan, mps, meta, hpu, mtia, 
)
...
for sheet_name in xls.sheet_names:
    ...
    # 为当前工作表（DataFrame）创建一个 PandasQueryEngine,为每一个表实例化引擎
